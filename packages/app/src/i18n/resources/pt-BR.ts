  ...
  settings: {
    ...
    host: {
      ...
      orchestration: {
        ...
        proxy: {
          title: "Proxy do OMP",
          hint: "Define PI_PROXY para novos processos do OMP. Limpe o valor para desativá-lo.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "URL do proxy do OMP",
          save: "Salvar",
          saving: "Salvando...",
          saveError: "Não foi possível salvar o proxy do OMP",
        },
        systemPrompt: {
