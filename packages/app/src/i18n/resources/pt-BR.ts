...
export const ptBR: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    methods: {
      ...
      github: {
        ...
        searchDescription: "Buscar projetos disponíveis para sua conta do GitHub",
        manualDescription: "Digite uma URL do GitHub ou owner/repo",
        unavailableDescription: "Atualize este host para clonar repositórios do GitHub",
      },
      newDirectory: {
        label: "Novo diretório",
        description: "Criar um diretório vazio em {{host}}",
        unavailableDescription: "Atualize este host para criar diretórios",
      },
    },
  ...
  composer: {
    ...
    attachments: {
      ...
      removeDirectory: "Remover anexo de pasta",
      ...
      quoteSelection: "Citar conteúdo",
      quotedContent: "Conteúdo citado",
      removeQuotedContent: "Remover conteúdo citado",
    },
    errors: {
      ...
      directoryPickFailed: "Falha ao selecionar pasta",
      directoryRequiresLocalDaemon: "Pastas só podem ser anexadas a um host local",
  ...
  agentControls: {
    ...
    mode: {
      ...
      options: {
        ...
        writeApproval: "Aprovar gravações",
  ...
  agentStream: {
    ...
    activityGroup: "Raciocínio e chamadas de ferramentas",
    permission: {
      plan: "Plano",
      required: "Permissão necessária",
      deny: "Negar",
      accept: "Aceitar",
      implement: "Aprovar e implementar",
      continuePlanning: "Continuar planejando",
    ...
    turnFileChanges: {
      ...
      showMore: "Mostrar mais {{count}} arquivos",
      moreCount: "+{{count}}",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não é gerenciado pelo OMP Desktop",
          mergePrNoForge:
      ...
      diff: {
        ...
        commits: {
          title: "Commits",
          countLabel: "{{count}} commits no branch atual",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        copyPath: "Copiar caminho",
        copyBranchName: "Copiar nome da branch",
        referenceContent: "Referenciar conteúdo",
      ...
      confirmations: {
        ...
        deleteTitle: "Excluir {{name}}?",
        deleteMessage:
          "Isso exclui permanentemente o histórico da conversa. Se este for um worktree gerenciado, os arquivos e alterações sem commit também serão removidos.",
      },
      rename: {
  ...
  newWorkspace: {
    ...
    errors: {
      hostDisconnected: "Host não está conectado",
      createWorkspaceFailed: "Falha ao criar workspace",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o OMP Desktop inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o OMP Desktop não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o OMP Desktop não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do OMP Desktop",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel:
        "Você está executando a build Intel do OMP Desktop pelo Rosetta no Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Teste de notificação do OMP Desktop",
  ...
  rootError: {
    title: "O OMP Desktop encontrou um problema.",
  ...
  workspaceSetup: {
    ...
    errors: {
      failedCreateWorkspace: "Falha ao criar workspace",
  ...
  onboarding: {
    title: "Bem-vindo ao OMP Desktop",
  ...
  modelSelector: {
    ...
    contextWindowUseDefault: "Usar padrão do modelo",
    contextWindowInputAccessibility: "Substituição da janela de contexto em tokens",
    contextWindowSave: "Salvar",
    contextWindowEdit: "Editar",
    contextWindowReset: "Redefinir",
    contextWindowInvalid: "Insira um número inteiro positivo de tokens.",
    contextWindowHint: "A substituição vale para novas sessões deste modelo.",
  },
  providerCatalog: {
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor OMP Desktop.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do OMP Desktop funciona",
  ...
  subagents: {
    ...
    pillLabelCompleted: "{{count}} concluídos",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "chamou o OMP Desktop {{count}} vez",
      other: "chamou o OMP Desktop {{count}} vezes",
    },
    and: "e",
  },
  renameModal: {
  ...
  settings: {
    memory: ompMemorySettings["pt-BR"],
    title: "Configurações",
    ...
    notifications: {
      ...
      sentDescription: "O OMP Desktop entregou a notificação ao sistema operacional.",
    ...
    metadataGeneration: {
      ...
      preferred: "Manual",
      automaticHint: "O OMP Desktop escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o OMP Desktop usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o OMP Desktop usa outro modelo disponível",
      docs: "Documentação",
    ...
    startup: {
      ...
      launchAtLoginHint: "Inicia o OMP Desktop automaticamente ao entrar",
      unsupportedHint: "Disponível no macOS e Windows",
    },
    general: {
      title: "Geral",
      browserData: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o OMP Desktop neste computador",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar OMP Desktop skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar OMP Desktop skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do OMP Desktop de ~/.agents, ~/.claude e ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do OMP Desktop",
          hint: "Injeta as ferramentas MCP do OMP Desktop nos agentes para que possam orquestrar recursos do Desktop além de trabalhar no diretório atual.",
          accessibilityLabel: "Injetar ferramentas do OMP Desktop",
          showDetails: "Ver recursos e impacto de segurança",
          hideDetails: "Ocultar recursos",
          capabilities: {
            workspace: {
              title: "Workspace e worktree",
              body: "Crie, liste, renomeie e arquive workspaces; use diretórios existentes; crie worktrees e branches Git; faça checkout de branches existentes ou PRs do GitHub. O arquivamento limpa os agentes e o diretório gerenciado.",
            },
            agents: {
              title: "Orquestração de agentes",
              body: "Crie agentes filhos ou independentes com uma tarefa inicial; envie mais trabalho a agentes existentes; consulte listas, status e atividades; altere nomes, rótulos, modelos, raciocínio e modos; cancele execuções, arquive ou encerre agentes; execute em segundo plano com notificações.",
            },
            permissions: {
              title: "Permissões",
              body: "Veja solicitações de permissão pendentes de todos os agentes e aprove ou negue, incluindo pedidos para executar comandos ou modificar arquivos.",
            },
            schedules: {
              title: "Tarefas agendadas",
              body: "Crie, veja, altere, pause, retome, exclua ou execute imediatamente tarefas cron. Configure fuso horário, máximo de execuções, expiração e histórico.",
            },
            heartbeat: {
              title: "Heartbeat",
              body: "Envie novamente um prompt ao agente atual em uma cadência cron para verificações, lembretes ou inspeção contínua.",
            },
            terminals: {
              title: "Terminais",
              body: "Crie, liste e feche terminais gerenciados pelo Desktop; leia a saída e envie texto, Enter, setas e outras entradas para observar ou operar serviços.",
            },
            scripts: {
              title: "Scripts do workspace",
              body: "Consulte scripts configurados no paseo.json; inicie ou pare; veja ciclo de vida, porta, URL de proxy, integridade e terminal associado.",
            },
            providers: {
              title: "Provedores e modelos",
              body: "Consulte provedores configurados e disponibilidade; liste modelos, modos e recursos; leia Agent Profiles para escolher uma configuração adequada.",
            },
          },
          optional: {
            title: "Recursos adicionais do host",
        ...
        proxy: {
          title: "Proxy",
          hint: "Usado por novos processos do OMP e solicitações de cota do Codex e Cursor. Limpe o valor para desativá-lo.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "URL do proxy",
          save: "Salvar",
          saving: "Salvando...",
          saveError: "Não foi possível salvar o proxy",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O OMP Desktop reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O OMP Desktop reconecta automaticamente. Tente novamente quando o host aparecer como online.",
          dialogFailedMessage: "Não foi possível abrir o diálogo de confirmação de reinício.",
        },
        update: {
          desktopManagedHint:
            "Este daemon é gerenciado pelo OMP Desktop Desktop. Atualize o OMP Desktop Desktop no host.",
    ...
    imageGeneration: {
      ...
      description:
        "Permite que os agentes gerem imagens raster e as exibam diretamente na conversa.",
      enabledAccessibilityLabel: "Ativar geração de imagens",
      status: {
        notConfigured: "Chave da API da OpenAI não configurada",
        environment: "Chave da API fornecida por OPENAI_API_KEY",
        configured: "Chave da API configurada",
        noSubscriptionAccount: "Nenhuma conta com assinatura do OpenAI Codex está conectada",
        selectSubscriptionAccount: "Selecione uma conta com assinatura do OpenAI Codex",
        subscriptionConfigured: "{{account}} · {{plan}}",
      },
      toolsDisabled:
        "A injeção de ferramentas Paseo está desativada. Ative-a nas configurações de orquestração do host.",
      source: {
        label: "Fonte de imagens",
        hint: "A cobrança da API e as assinaturas do ChatGPT são separadas. Não há alternância automática entre elas.",
        api: "API da OpenAI",
        subscription: "Assinatura do ChatGPT",
      },
      model: "Modelo de imagem",
      baseUrl: "URL base (opcional)",
      subscriptionAccount: "Conta do OpenAI Codex",
      subscriptionAccountPlaceholder: "Selecione uma conta com assinatura",
      subscriptionAccountEmpty: "Nenhuma conta do OpenAI Codex está conectada",
      subscriptionHint:
        "Usa a assinatura do ChatGPT da conta selecionada e o modelo fixo gpt-image-2.",
      accountFallback: "Conta do OpenAI Codex {{number}}",
      unknownPlan: "Assinatura",
      apiKey: "Chave da API da OpenAI",
      apiKeyConfiguredPlaceholder: "Configurada — insira uma nova chave para substituí-la",
      apiKeyPlaceholder: "sk-...",
      save: "Salvar",
      saving: "Salvando...",
      removeApiKey: "Remover chave da API",
      saveError: "Não foi possível salvar as configurações de geração de imagens",
    },
    providers: {
      omp: ompProviderSettings["pt-BR"],
      title: "Provedores",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "O OMP Desktop supervisiona o processo e atribui uma porta via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Geração de metadados",
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o OMP Desktop usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
