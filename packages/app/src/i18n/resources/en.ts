...
export const en = {
  ...
  addProjectFlow: {
    ...
    methods: {
      ...
      github: {
        ...
        unavailableDescription: "Update this host to clone GitHub repositories",
      },
      newDirectory: {
        label: "New directory",
        description: "Create an empty directory on {{host}}",
        unavailableDescription: "Update this host to create directories",
      },
    },
  ...
  composer: {
    ...
    attachments: {
      ...
      removeDirectory: "Remove folder attachment",
      ...
      quoteSelection: "Quote content",
      quotedContent: "Quoted content",
      removeQuotedContent: "Remove quoted content",
    },
    errors: {
      ...
      directoryPickFailed: "Failed to select folder",
      directoryRequiresLocalDaemon: "Folders can only be attached to a local host",
  ...
  agentStream: {
    ...
    activityGroup: "Thinking and tool calls",
    permission: {
      plan: "Plan",
      required: "Permission Required",
      deny: "Deny",
      accept: "Accept",
      implement: "Approve and implement",
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        commits: {
          title: "Commits",
          countLabel: "{{count}} commits on the current branch",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      confirmations: {
        ...
        deleteTitle: "Delete {{name}}?",
        deleteMessage:
          "This permanently deletes the conversation history. If this is a managed worktree, its files and any uncommitted changes are also removed.",
      },
      rename: {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let OMP Desktop start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but OMP Desktop could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit OMP Desktop",
      },
      logs: {
        title: "Log file",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of OMP Desktop under Rosetta on Apple Silicon.",
  ...
  rootError: {
    title: "OMP Desktop ran into a problem.",
  ...
  modelSelector: {
    ...
    contextWindowUseDefault: "Use model default",
    contextWindowInputAccessibility: "Context window override in tokens",
    contextWindowSave: "Save",
    contextWindowEdit: "Edit",
    contextWindowReset: "Reset",
    contextWindowInvalid: "Enter a positive whole number of tokens.",
    contextWindowHint: "Overrides apply to new sessions for this model.",
  },
  providerCatalog: {
    title: "Add provider",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a OMP Desktop server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how OMP Desktop relay works",
  ...
  subagents: {
    ...
    pillLabelCompleted: "{{count}} completed",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called OMP Desktop {{count}} time",
      other: "called OMP Desktop {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "OMP Desktop handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "OMP Desktop picks a fast available model",
      preferredHint: "Choose the model OMP Desktop uses",
      model: "Model",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates OMP Desktop on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update OMP Desktop skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall OMP Desktop skills?",
        uninstallMessage:
          "Removes all OMP Desktop orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      orchestration: {
        ...
        proxy: {
          title: "Proxy",
          hint: "Used by newly started OMP processes and provider quota requests such as Codex and Cursor. Clear the value to disable it.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "Proxy URL",
          save: "Save",
          saving: "Saving...",
          saveError: "Unable to save proxy",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. OMP Desktop reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. OMP Desktop reconnects automatically-try again once the host shows as online.",
    ...
    imageGeneration: {
      ...
      description: "Let agents generate raster images and show them directly in the conversation.",
      enabledAccessibilityLabel: "Enable image generation",
      status: {
        notConfigured: "OpenAI API key not configured",
        environment: "API key provided by OPENAI_API_KEY",
        configured: "API key configured",
        noSubscriptionAccount: "No OpenAI Codex subscription account is signed in",
        selectSubscriptionAccount: "Select an OpenAI Codex subscription account",
        subscriptionConfigured: "{{account}} · {{plan}}",
      },
      toolsDisabled: "Paseo tool injection is disabled. Enable it in Host orchestration settings.",
      source: {
        label: "Image source",
        hint: "API billing and ChatGPT subscriptions are separate. Requests never fall back between them.",
        api: "OpenAI API",
        subscription: "ChatGPT subscription",
      },
      model: "Image model",
      baseUrl: "Base URL (optional)",
      subscriptionAccount: "OpenAI Codex account",
      subscriptionAccountPlaceholder: "Select a subscription account",
      subscriptionAccountEmpty: "No OpenAI Codex accounts are signed in",
      subscriptionHint:
        "Uses the selected account's ChatGPT subscription and the fixed gpt-image-2 model.",
      accountFallback: "OpenAI Codex account {{number}}",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OMP Desktop supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts OMP Desktop uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
