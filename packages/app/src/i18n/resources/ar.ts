    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          warning:
            "وصول عالي الصلاحيات: يمكن للوكلاء إنشاء وكلاء آخرين وتعديل worktree وتشغيل الطرفيات وإنشاء الجداول. تظل أوضاع الجلسة وموافقة الأذونات وقيود دليل العمل وإعدادات المضيف سارية. لا يؤدي إيقاف هذا الخيار إلى إزالة أدوات الملفات أو الأوامر المدمجة، بل يزيل فقط أدوات تنسيق OMP Desktop.",
        },
        proxy: {
          title: "الوكيل",
