...
export const ar: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    methods: {
      directorySearch: {
        label: "البحث عن مجلد",
        description: "البحث عن مجلد على {{host}}",
      },
      browse: {
        label: "استعراض",
      ...
      github: {
        ...
        searchDescription: "البحث عن المشاريع المتاحة لحساب GitHub الخاص بك",
        manualDescription: "أدخل رابط GitHub أو owner/repo",
        unavailableDescription: "حدّث هذا المضيف لاستنساخ مستودعات GitHub",
      },
      newDirectory: {
        label: "مجلد جديد",
        description: "إنشاء مجلد فارغ على {{host}}",
        unavailableDescription: "حدّث هذا المضيف لإنشاء المجلدات",
      },
    },
  ...
  composer: {
    ...
    attachments: {
      ...
      removeDirectory: "إزالة مرفق المجلد",
      ...
      quoteSelection: "اقتباس المحتوى",
      quotedContent: "محتوى مقتبس",
      removeQuotedContent: "إزالة المحتوى المقتبس",
    },
    errors: {
      ...
      directoryPickFailed: "تعذر اختيار المجلد",
      directoryRequiresLocalDaemon: "لا يمكن إرفاق المجلدات إلا بمضيف محلي",
  ...
  agentStream: {
    ...
    activityGroup: "التفكير واستدعاءات الأدوات",
    permission: {
      plan: "يخطط",
      required: "الإذن مطلوب",
      deny: "ينكر",
      accept: "يقبل",
      implement: "الموافقة والتنفيذ",
      continuePlanning: "متابعة التخطيط",
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        commits: {
          title: "الإيداعات",
          countLabel: "{{count}} إيداعًا على الفرع الحالي",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        copyPath: "نسخ المسار",
        copyBranchName: "انسخ اسم الفرع",
        referenceContent: "الإشارة إلى المحتوى",
      ...
      confirmations: {
        ...
        deleteTitle: "حذف {{name}}؟",
        deleteMessage:
          "يؤدي هذا إلى حذف سجل المحادثة نهائيًا. إذا كانت هذه شجرة عمل مُدارة، فستُحذف ملفاتها وأي تغييرات غير ملتزم بها أيضًا.",
      },
      rename: {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ OMP Desktop ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        registrationFailed:
          "Built-in daemon started, but OMP Desktop could not save the localhost connection. Toggle daemon management off and on again, or add localhost manually.",
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن OMP Desktop من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء OMP Desktop",
      },
      logs: {
        title: "ملف السجل",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من OMP Desktop ضمن Rosetta على Apple Silicon.",
      highCpu:
  ...
  onboarding: {
    title: "مرحبا بكم في OMP Desktop",
  ...
  modelSelector: {
    ...
    contextWindowUseDefault: "استخدام الإعداد الافتراضي للنموذج",
    contextWindowInputAccessibility: "تجاوز نافذة السياق بالرموز",
    contextWindowSave: "حفظ",
    contextWindowEdit: "تعديل",
    contextWindowReset: "إعادة ضبط",
    contextWindowInvalid: "أدخل عددًا صحيحًا موجبًا من الرموز.",
    contextWindowHint: "ينطبق التجاوز على الجلسات الجديدة لهذا النموذج.",
  },
  providerCatalog: {
    title: "إضافة مزود",
    search: "مقدمي البحث",
  ...
  pairing: {
    ...
    direct: {
      title: "اتصال مباشر",
      helper: "أدخل عنوان خادم OMP Desktop.",
      fields: {
        host: "Host",
        port: "ميناء",
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع OMP Desktop",
  ...
  subagents: {
    ...
    pillLabelCompleted: "{{count}} مكتملة",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "استدعى OMP Desktop {{count}} مرة",
      other: "استدعى OMP Desktop {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم OMP Desktop الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار OMP Desktop نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه OMP Desktop",
      model: "النموذج",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث OMP Desktop على هذا الكمبيوتر",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات OMP Desktop ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات OMP Desktop ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق OMP Desktop من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "تمكين أدوات OMP Desktop",
          hint: "يضيف أدوات MCP الخاصة بـ OMP Desktop إلى الوكلاء ليتمكنوا من تنسيق موارد Desktop بالإضافة إلى العمل في الدليل الحالي.",
          accessibilityLabel: "إضافة أدوات OMP Desktop",
          showDetails: "عرض الإمكانات وتأثير الأمان",
          hideDetails: "إخفاء الإمكانات",
          capabilities: {
            workspace: {
              title: "Workspace وworktree",
              body: "إنشاء مساحات العمل وعرضها وإعادة تسميتها وأرشفتها؛ استخدام دليل موجود؛ إنشاء Git worktree وفروع؛ checkout لفرع موجود أو GitHub PR. تؤدي الأرشفة إلى تنظيف الوكلاء والدليل المُدار.",
            },
            agents: {
              title: "تنسيق الوكلاء",
              body: "إنشاء وكلاء فرعيين أو مستقلين بمهمة أولية؛ إرسال مهام إضافية إلى الوكلاء الحاليين؛ عرض القوائم والحالة والنشاط؛ تغيير الأسماء والتصنيفات والنماذج وإعدادات التفكير والأوضاع؛ إلغاء التشغيل أو الأرشفة أو الإنهاء؛ التشغيل في الخلفية مع إشعارات الإكمال.",
            },
            permissions: {
              title: "الأذونات",
              body: "عرض طلبات الأذونات المعلقة لجميع الوكلاء والموافقة عليها أو رفضها، بما في ذلك طلبات تشغيل الأوامر أو تعديل الملفات.",
            },
            schedules: {
              title: "المهام المجدولة",
              body: "إنشاء مهام cron وعرضها وتعديلها وإيقافها مؤقتًا واستئنافها وحذفها أو تشغيلها فورًا. يدعم المناطق الزمنية والحد الأقصى للتشغيل وانتهاء الصلاحية وسجل التشغيل.",
            },
            heartbeat: {
              title: "Heartbeat",
              body: "إعادة إرسال مطالبة إلى الوكيل الحالي وفق جدول cron للفحوصات الدورية أو التذكيرات أو المراقبة المستمرة.",
            },
            terminals: {
              title: "الطرفيات",
              body: "إنشاء الطرفيات التي يديرها Desktop وعرضها وإغلاقها؛ قراءة المخرجات وإرسال النص وEnter ومفاتيح الأسهم ومدخلات أخرى لمراقبة الخدمات أو تشغيلها.",
            },
            scripts: {
              title: "برامج Workspace النصية",
              body: "عرض البرامج النصية المضبوطة في paseo.json؛ تشغيلها وإيقافها؛ عرض دورة الحياة والمنفذ وعنوان الوكيل والحالة والطرفية المرتبطة.",
            },
            providers: {
              title: "الموفرون والنماذج",
              body: "عرض الموفرين المضبوطين وتوفرهم؛ سرد النماذج والأوضاع والميزات؛ قراءة ملفات تعريف الوكلاء لاختيار إعداد نموذج مناسب.",
            },
          },
          optional: {
            title: "إمكانات مضيف إضافية",
            body: "قد تتيح إعدادات وإمكانات المضيف الأخرى أيضًا أتمتة المتصفح وإنشاء الصور والإخراج الصوتي.",
          },
          warning:
            "وصول عالي الصلاحيات: يمكن للوكلاء إنشاء وكلاء آخرين وتعديل worktree وتشغيل الطرفيات وإنشاء الجداول. تظل أوضاع الجلسة وموافقة الأذونات وقيود دليل العمل وإعدادات المضيف سارية. يؤدي إيقاف قدرة واحدة إلى إزالة مجموعة أدوات OMP Desktop المقابلة فقط، بينما يؤدي إيقاف المفتاح الرئيسي إلى إزالة جميع أدوات تنسيق OMP Desktop. لا يؤدي أي من الإجراءين إلى تعطيل أدوات الملفات أو الأوامر المدمجة في الوكيل.",
        },
        proxy: {
          title: "الوكيل",
          hint: "يُستخدم لعمليات OMP الجديدة وطلبات حصة Codex وCursor. امسح القيمة لتعطيله.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "عنوان الوكيل",
          save: "حفظ",
          saving: "جارٍ الحفظ...",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم OMP Desktop بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم OMP Desktop بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
    ...
    imageGeneration: {
      title: "إنشاء الصور",
      enabled: "تفعيل إنشاء الصور",
      description: "السماح للوكلاء بإنشاء صور نقطية وعرضها مباشرة في المحادثة.",
      enabledAccessibilityLabel: "تفعيل إنشاء الصور",
      status: {
        notConfigured: "مفتاح OpenAI API غير مهيأ",
        environment: "مفتاح API مقدم عبر OPENAI_API_KEY",
        configured: "مفتاح API مهيأ",
        noSubscriptionAccount: "لم يتم تسجيل الدخول إلى حساب اشتراك OpenAI Codex",
        selectSubscriptionAccount: "اختر حساب اشتراك OpenAI Codex",
        subscriptionConfigured: "{{account}} · {{plan}}",
      },
      toolsDisabled: "حقن أدوات Paseo معطل. فعّله من إعدادات تنسيق المضيف.",
      source: {
        label: "مصدر الصور",
        hint: "فوترة API واشتراكات ChatGPT منفصلة، ولا يتم التبديل بينهما تلقائيًا.",
        api: "OpenAI API",
        subscription: "اشتراك ChatGPT",
      },
      model: "نموذج الصور",
      baseUrl: "عنوان URL الأساسي (اختياري)",
      subscriptionAccount: "حساب OpenAI Codex",
      subscriptionAccountPlaceholder: "اختر حساب اشتراك",
      subscriptionAccountEmpty: "لا توجد حسابات OpenAI Codex مسجلة الدخول",
      subscriptionHint: "يستخدم اشتراك ChatGPT للحساب المحدد ونموذج gpt-image-2 الثابت.",
      accountFallback: "حساب OpenAI Codex {{number}}",
      unknownPlan: "اشتراك",
      apiKey: "مفتاح OpenAI API",
      apiKeyConfiguredPlaceholder: "مهيأ — أدخل مفتاحًا جديدًا لاستبداله",
      apiKeyPlaceholder: "sk-...",
      save: "حفظ",
      saving: "جارٍ الحفظ...",
      removeApiKey: "إزالة مفتاح API",
      saveError: "تعذر حفظ إعدادات إنشاء الصور",
    },
    providers: {
      omp: ompProviderSettings.ar,
      title: "مقدمي الخدمات",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "يشرف OMP Desktop على العملية ويعين منفذًا عبر $PASEO_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه OMP Desktop لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
