...
export const ja: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    methods: {
      ...
      github: {
        label: "GitHub からクローン",
        searchDescription: "GitHub アカウントで利用可能なプロジェクトを検索",
        manualDescription: "GitHub URL または owner/repo を入力",
        unavailableDescription: "GitHub リポジトリをクローンするにはホストを更新してください",
      },
      newDirectory: {
        label: "新規ディレクトリ",
        description: "{{host}} 上に空のディレクトリを作成",
        unavailableDescription: "ディレクトリを作成するにはホストを更新してください",
      },
    },
    updateHost: "「プロジェクトを追加」を使用するにはホストを更新してください。",
  ...
  composer: {
    ...
    attachments: {
      ...
      quoteSelection: "内容を引用",
      quotedContent: "引用した内容",
      removeQuotedContent: "引用した内容を削除",
    },
    errors: {
      ...
      directoryPickFailed: "フォルダを選択できませんでした",
      directoryRequiresLocalDaemon: "フォルダはローカルホストにのみ添付できます",
  ...
  agentControls: {
    ...
    mode: {
      ...
      options: {
        alwaysAsk: "常に確認",
        writeApproval: "書き込みを承認",
        fullAccess: "フルアクセス",
        auto: "自動",
        plan: "計画",
        default: "デフォルト",
        acceptEdits: "編集を許可",
        bypassPermissions: "権限確認を省略",
        build: "ビルド",
      },
    },
    hints: {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        commits: {
          title: "コミット",
          countLabel: "現在のブランチのコミット数: {{count}}",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      confirmations: {
        ...
        deleteTitle: "{{name}}を削除しますか？",
        deleteMessage:
          "会話履歴を完全に削除します。管理対象のworktreeの場合、ファイルと未コミットの変更も削除されます。",
      },
      rename: {
        title: "ワークスペースの名前を変更",
        submit: "名前を変更",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "組み込みデーモンを管理",
        hint: "OMP Desktopが組み込みデーモンを起動・停止できるようにする",
        pauseTitle: "組み込みデーモンを一時停止",
        pauseMessage:
          "これにより組み込みデーモンが即座に停止します。組み込みデーモンに接続されている実行中のエージェントとターミナルが停止されます。",
        pauseAndStop: "一時停止して停止",
        registrationFailed:
          "組み込みデーモンは起動しましたが、OMP Desktopがlocalhostの接続を保存できませんでした。デーモン管理をオフにしてから再度オンにするか、localhostを手動で追加してください。",
        pausedStopFailed:
          "組み込みデーモン管理は一時停止されましたが、OMP Desktopがデーモンを停止できませんでした。",
        updateFailed: "組み込みデーモン管理を更新できません。",
      },
      keepRunning: {
        title: "終了後もデーモンを実行し続ける",
        hint: "OMP Desktopを終了してもデーモンは実行し続けます",
      },
      logs: {
        title: "ログファイル",
        modalTitle: "デーモンログ",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon上のRosettaでOMP DesktopのIntelビルドを実行しています。",
      highCpu:
  ...
  modelSelector: {
    ...
    contextWindowUseDefault: "モデルの既定値を使用",
    contextWindowInputAccessibility: "コンテキストウィンドウの上書き（トークン）",
    contextWindowSave: "保存",
    contextWindowEdit: "編集",
    contextWindowReset: "リセット",
    contextWindowInvalid: "正の整数のトークン数を入力してください。",
    contextWindowHint: "上書きは、このモデルの新しいセッションに適用されます。",
  },
  providerCatalog: {
    title: "プロバイダーを追加",
    search: "プロバイダーを検索",
  ...
  pairing: {
    ...
    direct: {
      title: "直接接続",
      helper: "OMP Desktopサーバーのアドレスを入力してください。",
      fields: {
        host: "ホスト",
        port: "ポート",
        password: "パスワード",
    ...
    device: {
      ...
      relayDocs: "リレーの仕組み",
      relayDocsAccessibility: "OMP Desktop リレーの仕組みを読む",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "OMP Desktopを{{count}}回呼び出し",
      other: "OMP Desktopを{{count}}回呼び出し",
    },
    and: "および",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "OMP Desktop が通知をオペレーティングシステムに渡しました。",
    ...
    metadataGeneration: {
      ...
      automatic: "自動",
      preferred: "手動",
      automaticHint: "OMP Desktop が利用可能な高速モデルを選択します",
      preferredHint: "OMP Desktop が使用するモデルを選択します",
      model: "モデル",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "このコンピューターのOMP Desktopを更新します",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "OMP Desktopスキルを更新しますか？",
        updateFallback: "バンドルされたスキルをマシンに同期します。",
        uninstallTitle: "OMP Desktopスキルをアンインストールしますか？",
        uninstallMessage:
          "~/.agents、~/.claude、~/.codexからすべてのOMP Desktopオーケストレーションスキルを削除します。",
        choose: "スキルを選択",
        chooseAll: "すべてのスキル",
        chooseAllHint:
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          warning:
            "高権限アクセス：Agentは他のAgentの作成、worktreeの操作、ターミナルの起動、スケジュールの作成ができます。セッションモード、権限承認、作業ディレクトリ制限、ホスト設定は引き続き適用されます。個別の機能を無効にすると対応するOMP Desktopツール群だけが削除され、メインスイッチを無効にするとすべてのOMP Desktopオーケストレーションツールが削除されます。どちらの場合もAgent内蔵のファイル・コマンドツールは無効になりません。",
        },
        proxy: {
          title: "プロキシ",
          hint: "新しく起動するOMPプロセスとCodex、Cursorのクォータ取得に使用します。無効にするには値を消去してください。",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "プロキシURL",
          save: "保存",
          saving: "保存中...",
          saveError: "プロキシを保存できません",
        },
        systemPrompt: {
          title: "システムプロンプト",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "このホストはオフラインです。OMP Desktopが自動再接続します。再起動は、ホストがオンラインに戻ってから行ってください。",
          requestFailedTitle: "エラー",
          requestFailedMessage:
            "再起動リクエストの送信に失敗しました。OMP Desktopは自動的に再接続します。ホストがオンラインになったら再試行してください。",
    ...
    imageGeneration: {
      title: "画像生成",
      enabled: "画像生成を有効にする",
      description: "エージェントがラスター画像を生成し、会話内に直接表示できるようにします。",
      enabledAccessibilityLabel: "画像生成を有効にする",
      status: {
        notConfigured: "OpenAI API キーが未設定です",
        environment: "API キーは OPENAI_API_KEY から提供されています",
        configured: "API キー設定済み",
        noSubscriptionAccount: "OpenAI Codex サブスクリプションアカウントにログインしていません",
        selectSubscriptionAccount: "OpenAI Codex サブスクリプションアカウントを選択してください",
        subscriptionConfigured: "{{account}} · {{plan}}",
      },
      toolsDisabled:
        "Paseo ツール注入が無効です。ホストのオーケストレーション設定で有効にしてください。",
      source: {
        label: "画像ソース",
        hint: "API 課金と ChatGPT サブスクリプションは別です。自動的に切り替わることはありません。",
        api: "OpenAI API",
        subscription: "ChatGPT サブスクリプション",
      },
      model: "画像モデル",
      baseUrl: "ベース URL（任意）",
      subscriptionAccount: "OpenAI Codex アカウント",
      subscriptionAccountPlaceholder: "サブスクリプションアカウントを選択",
      subscriptionAccountEmpty: "ログイン済みの OpenAI Codex アカウントがありません",
      subscriptionHint:
        "選択したアカウントの ChatGPT サブスクリプションと固定の gpt-image-2 モデルを使用します。",
      accountFallback: "OpenAI Codex アカウント {{number}}",
      unknownPlan: "サブスクリプション",
      apiKey: "OpenAI API キー",
      apiKeyConfiguredPlaceholder: "設定済み — 新しいキーを入力すると置き換えられます",
      apiKeyPlaceholder: "sk-...",
      save: "保存",
      saving: "保存中...",
      removeApiKey: "API キーを削除",
      saveError: "画像生成設定を保存できません",
    },
    providers: {
      omp: ompProviderSettings.ja,
      title: "プロバイダー",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OMP Desktopがプロセスを監督し、$PASEO_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
      ...
      metadata: {
        title: "メタデータ生成",
        info: "OMP Desktopがメタデータ生成に使うAIプロンプトへ追加する、プロジェクト固有の指示です。ブランチ名、コミット形式、PR形式など、チームの規約を反映するために使います。",
        branchName: "ブランチ名",
