...
export const ko: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    methods: {
      ...
      github: {
        label: "GitHub에서 복제",
        searchDescription: "GitHub 계정에서 사용 가능한 프로젝트 검색",
        manualDescription: "GitHub URL 또는 owner/repo 입력",
        unavailableDescription: "GitHub 저장소를 복제하려면 이 호스트를 업데이트하세요",
      },
      newDirectory: {
        label: "새 디렉터리",
        description: "{{host}}에 빈 디렉터리 생성",
        unavailableDescription: "디렉터리를 생성하려면 이 호스트를 업데이트하세요",
      },
    },
    updateHost: "프로젝트 추가를 사용하려면 호스트를 업데이트하세요.",
  ...
  composer: {
    ...
    attachments: {
      ...
      quoteSelection: "내용 인용",
      quotedContent: "인용한 내용",
      removeQuotedContent: "인용한 내용 제거",
    },
    errors: {
      ...
      directoryPickFailed: "폴더를 선택하지 못했습니다",
      directoryRequiresLocalDaemon: "폴더는 로컬 호스트에만 첨부할 수 있습니다",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      confirmations: {
        ...
        deleteTitle: "{{name}}을(를) 삭제할까요?",
        deleteMessage:
          "대화 기록이 영구적으로 삭제됩니다. 관리되는 worktree인 경우 파일과 커밋되지 않은 변경 사항도 삭제됩니다.",
      },
      rename: {
        title: "워크스페이스 이름 변경",
        submit: "이름 변경",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "내장 데몬 관리",
        hint: "OMP Desktop가 내장 데몬을 시작하고 중지하도록 허용합니다",
        pauseTitle: "내장 데몬 일시 중지",
        pauseMessage:
          "내장 데몬이 즉시 중지됩니다. 내장 데몬에 연결된 실행 중인 에이전트와 터미널이 중지됩니다.",
        pauseAndStop: "일시 중지 후 중지",
        registrationFailed:
          "내장 데몬이 시작되었지만 OMP Desktop가 localhost 연결을 저장하지 못했습니다. 데몬 관리를 껐다가 다시 켜거나 localhost를 수동으로 추가하세요.",
        pausedStopFailed:
          "내장 데몬 관리가 일시 중지되었지만 OMP Desktop가 데몬을 중지하지 못했습니다.",
        updateFailed: "내장 데몬 관리를 업데이트할 수 없습니다.",
      },
      keepRunning: {
        title: "종료 후에도 데몬 계속 실행",
        hint: "OMP Desktop를 종료해도 데몬이 계속 실행됩니다",
      },
      logs: {
        title: "로그 파일",
        modalTitle: "데몬 로그",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon에서 Rosetta로 OMP Desktop의 Intel 빌드를 실행하고 있습니다.",
      highCpu:
  ...
  onboarding: {
    title: "OMP Desktop에 오신 것을 환영합니다",
  ...
  modelSelector: {
    ...
    contextWindowUseDefault: "모델 기본값 사용",
    contextWindowInputAccessibility: "컨텍스트 창 재정의(토큰)",
    contextWindowSave: "저장",
    contextWindowEdit: "편집",
    contextWindowReset: "재설정",
    contextWindowInvalid: "양의 정수 토큰 수를 입력하세요.",
    contextWindowHint: "재정의는 이 모델의 새 세션에 적용됩니다.",
  },
  providerCatalog: {
    title: "프로바이더 추가",
    search: "프로바이더 검색",
  ...
  pairing: {
    ...
    direct: {
      title: "직접 연결",
      helper: "OMP Desktop 서버의 주소를 입력하세요.",
      fields: {
        host: "호스트",
        port: "포트",
        password: "비밀번호",
    ...
    device: {
      ...
      relayDocs: "릴레이 작동 방식",
      relayDocsAccessibility: "OMP Desktop 릴레이 작동 방식 읽기",
      enableRelay: "릴레이 활성화",
      enablingRelay: "활성화 중...",
      notNow: "지금은 아님",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "OMP Desktop를 {{count}}회 호출함",
      other: "OMP Desktop를 {{count}}회 호출함",
    },
    and: "그리고",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "OMP Desktop가 알림을 운영 체제에 전달했습니다.",
    ...
    metadataGeneration: {
      ...
      automatic: "자동",
      preferred: "수동",
      automaticHint: "OMP Desktop가 사용 가능한 빠른 모델을 선택합니다",
      preferredHint: "OMP Desktop에서 사용할 모델을 선택하세요",
      model: "모델",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "이 컴퓨터의 OMP Desktop를 업데이트합니다",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "OMP Desktop 스킬을 업데이트할까요?",
        updateFallback: "번들된 스킬을 내 컴퓨터에 동기화합니다.",
        uninstallTitle: "OMP Desktop 스킬을 제거할까요?",
        uninstallMessage:
          "~/.agents, ~/.claude, ~/.codex에서 모든 OMP Desktop 오케스트레이션 스킬을 제거합니다.",
        choose: "스킬 선택",
        chooseAll: "모든 스킬",
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          warning:
            "높은 권한의 접근입니다. Agent는 다른 Agent 생성, worktree 조작, 터미널 실행 및 예약 작업 생성을 수행할 수 있습니다. 세션 모드, 권한 승인, 작업 디렉터리 제한 및 호스트 설정은 계속 적용됩니다. 개별 기능을 끄면 해당 OMP Desktop 도구 그룹만 제거되고, 기본 스위치를 끄면 모든 OMP Desktop 오케스트레이션 도구가 제거됩니다. 어느 경우에도 Agent의 기본 파일 또는 명령 도구는 비활성화되지 않습니다.",
        },
        proxy: {
          title: "프록시",
          hint: "새로 시작되는 OMP 프로세스와 Codex, Cursor 할당량 요청에 사용됩니다. 비활성화하려면 값을 지우세요.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "프록시 URL",
          save: "저장",
          saving: "저장 중...",
          saveError: "프록시를 저장할 수 없습니다",
        },
        systemPrompt: {
          title: "시스템 프롬프트",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "이 호스트는 오프라인입니다. OMP Desktop가 자동으로 다시 연결하므로 다시 온라인이 될 때까지 기다린 후 재시작하세요.",
          requestFailedTitle: "오류",
          requestFailedMessage:
            "재시작 요청을 보내지 못했습니다. OMP Desktop가 자동으로 다시 연결하므로 호스트가 온라인으로 표시되면 다시 시도하세요.",
    ...
    imageGeneration: {
      title: "이미지 생성",
      enabled: "이미지 생성 사용",
      description: "에이전트가 래스터 이미지를 생성하고 대화에 바로 표시하도록 합니다.",
      enabledAccessibilityLabel: "이미지 생성 사용",
      status: {
        notConfigured: "OpenAI API 키가 설정되지 않음",
        environment: "OPENAI_API_KEY에서 API 키를 제공함",
        configured: "API 키 설정됨",
        noSubscriptionAccount: "로그인된 OpenAI Codex 구독 계정이 없습니다",
        selectSubscriptionAccount: "OpenAI Codex 구독 계정을 선택하세요",
        subscriptionConfigured: "{{account}} · {{plan}}",
      },
      toolsDisabled: "Paseo 도구 주입이 꺼져 있습니다. 호스트 오케스트레이션 설정에서 켜세요.",
      source: {
        label: "이미지 소스",
        hint: "API 결제와 ChatGPT 구독은 별개이며 자동으로 전환되지 않습니다.",
        api: "OpenAI API",
        subscription: "ChatGPT 구독",
      },
      model: "이미지 모델",
      baseUrl: "기본 URL(선택 사항)",
      subscriptionAccount: "OpenAI Codex 계정",
      subscriptionAccountPlaceholder: "구독 계정 선택",
      subscriptionAccountEmpty: "로그인된 OpenAI Codex 계정이 없습니다",
      subscriptionHint: "선택한 계정의 ChatGPT 구독과 고정된 gpt-image-2 모델을 사용합니다.",
      accountFallback: "OpenAI Codex 계정 {{number}}",
      unknownPlan: "구독",
      apiKey: "OpenAI API 키",
      apiKeyConfiguredPlaceholder: "설정됨 — 새 키를 입력하면 교체됩니다",
      apiKeyPlaceholder: "sk-...",
      save: "저장",
      saving: "저장 중...",
      removeApiKey: "API 키 제거",
      saveError: "이미지 생성 설정을 저장할 수 없습니다",
    },
    providers: {
      omp: ompProviderSettings.ko,
      title: "프로바이더",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OMP Desktop가 프로세스를 감독하고 $PASEO_PORT를 통해 포트를 할당합니다",
        actions: {
          add: "스크립트 추가",
          edit: "편집",
          remove: "제거",
      ...
      metadata: {
        title: "메타데이터 생성",
        info: "OMP Desktop가 메타데이터를 생성하는 데 사용하는 AI 프롬프트에 주입되는 프로젝트별 지침 - 브랜치 이름, 커밋 스타일, PR 형식 같은 팀 규칙을 적용하는 데 사용하세요",
        branchName: "브랜치 이름",
