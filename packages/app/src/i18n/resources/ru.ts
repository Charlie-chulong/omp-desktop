...
export const ru: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    methods: {
      ...
      github: {
        ...
        searchDescription: "Найти проекты, доступные вашей учётной записи GitHub",
        manualDescription: "Введите URL GitHub или owner/repo",
        unavailableDescription: "Обновите этот хост для клонирования репозиториев GitHub",
      },
      newDirectory: {
        label: "Новый каталог",
        description: "Создать пустой каталог на {{host}}",
        unavailableDescription: "Обновите этот хост для создания каталогов",
      },
    },
    updateHost: "Обновите хост, чтобы использовать добавление проекта.",
  ...
  composer: {
    ...
    attachments: {
      ...
      removeDirectory: "Удалить прикрепленную папку",
      ...
      quoteSelection: "Цитировать содержимое",
      quotedContent: "Цитируемое содержимое",
      removeQuotedContent: "Удалить цитируемое содержимое",
    },
    errors: {
      ...
      directoryPickFailed: "Не удалось выбрать папку",
      directoryRequiresLocalDaemon: "Папки можно прикреплять только к локальному хосту",
  ...
  agentControls: {
    ...
    mode: {
      ...
      options: {
        ...
        writeApproval: "Подтверждать запись",
        fullAccess: "Полный доступ",
        auto: "Автоматически",
        plan: "План",
        default: "По умолчанию",
        acceptEdits: "Разрешить изменения",
        bypassPermissions: "Не запрашивать разрешения",
        build: "Сборка",
      },
    },
    hints: {
  ...
  agentStream: {
    ...
    activityGroup: "Рассуждения и вызовы инструментов",
    permission: {
      plan: "План",
      required: "Требуется разрешение",
      deny: "Отклонить",
      accept: "Разрешить",
      implement: "Утвердить и реализовать",
    ...
    turnFileChanges: {
      ...
      deleted: "Удалён {{name}}",
      showMore: "Показать ещё {{count}} файлов",
      moreCount: "+{{count}}",
      collapse: "Свернуть",
  ...
  agentPanel: {
    states: {
      ...
      historyUnavailableTitle: "История разговора недоступна",
      historyUnavailableMissing:
        "Агент по-прежнему существует, но файл разговора провайдера удалён. Сохранённые выше сообщения, если они есть, доступны только для чтения.",
      historyUnavailableMalformed:
        "Агент по-прежнему существует, но файл разговора провайдера неполон или повреждён. Сохранённые выше сообщения, если они есть, доступны только для чтения.",
      historyUnavailableEmpty: "Нет сообщений разговора, которые можно восстановить.",
  ...
  message: {
    ...
    todo: {
      ...
      collapse: "Свернуть задачи",
      expand: "Показать задачи",
      activity: {
    ...
    git: {
      ...
      diff: {
        staging: {
          ...
          changes: "Изменения",
          stage: "Индексировать изменения",
          unstage: "Убрать изменения из индекса",
          failedStage: "Не удалось индексировать изменения",
          failedUnstage: "Не удалось убрать изменения из индекса",
        },
        ...
        commits: {
          title: "Коммиты",
          countLabel: "Коммитов текущей ветки: {{count}}",
  ...
  sidebar: {
    ...
    project: {
      ...
      drop: {
        ...
        failed: "Не удалось добавить папку",
      },
      empty: {
    ...
    workspace: {
      ...
      actions: {
        ...
        referenceContent: "Сослаться на содержимое",
      ...
      confirmations: {
        ...
        deleteMessage:
          "История диалога будет удалена навсегда. Если это управляемое рабочее дерево, его файлы и незафиксированные изменения также будут удалены.",
      },
      rename: {
      ...
      toasts: {
        ...
        hostDisconnected: "Хост не подключён",
        referenceContentFailed: "Не удалось сослаться на содержимое диалога",
        hideFailed: "Не удалось скрыть рабочее пространство",
        archiveFailed: "Не удалось архивировать рабочее пространство",
        emptyArchiveFailed:
          "Не удалось удалить неиспользуемое рабочее пространство: {{reason}}. Оно осталось в боковой панели; откройте его и закройте пустую вкладку, чтобы повторить попытку.",
        updateHostToArchiveEmpty:
          "Обновите хост для безопасного удаления неиспользуемых рабочих пространств",
  ...
  desktop: {
    quitting: {
      title: "Завершение работы OMP Desktop...",
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Разрешить OMP Desktop запускать и останавливать встроенный демон",
        ...
        registrationFailed:
          "Встроенный демон запущен, но OMP Desktop не удалось сохранить подключение к localhost. Выключите и снова включите управление демоном или добавьте localhost вручную.",
        pausedStopFailed:
          "Встроенное управление демоном было приостановлено, но OMP Desktop не смог остановить демон.",
        updateFailed: "Не удалось изменить настройки управления встроенным демоном.",
      },
      keepRunning: {
        title: "Продолжать работу демона после выхода",
        hint: "Демон продолжит работать после выхода из OMP Desktop",
      },
      logs: {
        title: "Файл журнала",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку OMP Desktop для Intel через Rosetta на Apple Silicon.",
      highCpu:
  ...
  rootError: {
    title: "В OMP Desktop возникла проблема.",
  ...
  onboarding: {
    title: "Добро пожаловать в OMP Desktop",
  ...
  modelSelector: {
    ...
    contextWindowUseDefault: "Использовать значение модели",
    contextWindowInputAccessibility: "Переопределение контекстного окна в токенах",
    contextWindowSave: "Сохранить",
    contextWindowEdit: "Изменить",
    contextWindowReset: "Сбросить",
    contextWindowInvalid: "Введите положительное целое число токенов.",
    contextWindowHint: "Переопределение применяется к новым сессиям этой модели.",
  },
  providerCatalog: {
  ...
  pairing: {
    ...
    direct: {
      title: "Прямое подключение",
      helper: "Введите адрес сервера OMP Desktop.",
      fields: {
        host: "Хост",
        port: "Порт",
        password: "Пароль",
    ...
    link: {
      ...
      errors: {
        ...
        relayConnectionFailed:
          "Не удалось подключиться через {{relay}}. Веб-приложение и демон должны использовать один ретранслятор; в ссылке указан {{advertisedRelay}}. Проверьте состояние ретранслятора демона или очистите настройку приложения, чтобы использовать адрес из ссылки. Подробности: {{detail}}",
      },
      alert: {
    ...
    relayAddress: {
      label: "Адрес сервера ретрансляции",
      description:
        "Используется при добавлении хостов по ссылкам сопряжения. Веб-приложение и демон должны подключаться к одному ретранслятору. Укажите ws:// или wss:// либо оставьте поле пустым, чтобы использовать адрес из ссылки. Трафик остаётся защищён сквозным шифрованием.",
      invalid:
        "Введите корректный адрес ws:// или wss:// без учётных данных, строки запроса и фрагмента. Поддерживаются только пути / и /ws.",
      save: "Сохранить адрес",
      saving: "Сохранение...",
      saved: "Настройка сохранена и будет применена при следующем добавлении хоста.",
    },
    device: {
      ...
      relayDocsAccessibility: "Узнать, как работает ретранслятор OMP Desktop",
      ...
      updateRequired: "Обновите хост, чтобы включить ретранслятор из OMP Desktop Desktop.",
      unavailable: "Данные для сопряжения недоступны.",
      hint: "Скопируйте эту ссылку, откройте OMP Desktop Web на другом устройстве и выберите Добавить хост → Вставить ссылку сопряжения.",
      securityWarning:
  ...
  subagents: {
    ...
    pillLabelCompleted: "{{count}} завершено",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "выполнен {{count}} вызов OMP Desktop",
      other: "выполнены вызовы OMP Desktop ({{count}})",
    },
    and: "и",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "OMP Desktop передал уведомление операционной системе.",
    ...
    metadataGeneration: {
      ...
      automatic: "Автоматически",
      preferred: "Вручную",
      automaticHint: "OMP Desktop выбирает быструю доступную модель",
      preferredHint: "Выберите модель, которую использует OMP Desktop",
      model: "Модель",
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        description:
          "Переключитесь на бета-канал, чтобы раньше получать обновления и помогать развивать OMP Desktop.",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
        ...
        installMessage: "Это обновит OMP Desktop на этом компьютере.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Обновить навыки OMP Desktop?",
        updateFallback: "Встроенные навыки будут синхронизированы с этим хостом.",
        uninstallTitle: "Удалить навыки OMP Desktop?",
        uninstallMessage:
          "Удаляет все навыки оркестрации OMP Desktop из ~/.agents, ~/.claude и ~/.codex на этом хосте.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Включить инструменты OMP Desktop",
          hint: "Добавляет MCP-инструменты OMP Desktop агентам, чтобы они могли управлять ресурсами Desktop помимо работы в текущем каталоге.",
          accessibilityLabel: "Добавить инструменты OMP Desktop",
          showDetails: "Показать возможности и влияние на безопасность",
          hideDetails: "Скрыть возможности",
          capabilities: {
            workspace: {
              title: "Workspace и worktree",
              body: "Создание, просмотр, переименование и архивирование workspace; использование существующих каталогов; создание Git worktree и веток; checkout существующих веток и GitHub PR. При архивировании очищаются агенты и управляемый каталог.",
            },
            agents: {
              title: "Оркестрация агентов",
              body: "Создание дочерних или независимых агентов с начальной задачей; отправка новых задач существующим агентам; просмотр списков, состояния и активности; изменение имени, меток, модели, параметров мышления и режима; отмена, архивирование и завершение; фоновый запуск и уведомления.",
            },
            permissions: {
              title: "Разрешения",
              body: "Просмотр ожидающих запросов разрешений всех агентов и их одобрение или отклонение, включая выполнение команд и изменение файлов.",
            },
            schedules: {
              title: "Задачи по расписанию",
              body: "Создание, просмотр, изменение, приостановка, возобновление, удаление и немедленный запуск cron-задач. Поддерживаются часовой пояс, максимум запусков, срок действия и история.",
            },
            heartbeat: {
              title: "Heartbeat",
              body: "Повторная отправка текущему агенту промпта по cron для регулярных проверок, напоминаний и постоянного мониторинга.",
            },
            terminals: {
              title: "Терминалы",
              body: "Создание, просмотр и закрытие терминалов под управлением Desktop; чтение вывода и отправка текста, Enter, стрелок и других клавиш для наблюдения и управления сервисами.",
            },
            scripts: {
              title: "Workspace scripts",
              body: "Просмотр настроенных в paseo.json скриптов; запуск и остановка; просмотр жизненного цикла, порта, URL прокси, состояния и связанного терминала.",
            },
            providers: {
              title: "Провайдеры и модели",
              body: "Просмотр настроенных провайдеров и доступности; списка моделей, режимов и функций; чтение Agent Profiles для выбора подходящей конфигурации.",
            },
          },
          optional: {
            title: "Дополнительные возможности хоста",
            body: "Другие настройки и возможности хоста также могут предоставлять автоматизацию браузера, генерацию изображений и голосовой вывод.",
          },
          warning:
            "Высокие привилегии: агенты могут создавать других агентов, изменять worktree, запускать терминалы и создавать расписания. Продолжают действовать режим сессии, подтверждение разрешений, ограничения рабочего каталога и настройки хоста. Отключение отдельной возможности удаляет только соответствующую группу инструментов OMP Desktop, а главный переключатель удаляет все инструменты оркестрации OMP Desktop. Ни одно из этих действий не отключает встроенные файловые и командные инструменты агента.",
        },
        proxy: {
          title: "Прокси",
          hint: "Используется новыми процессами OMP и запросами квот Codex и Cursor. Очистите значение, чтобы отключить прокси.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "URL прокси",
          save: "Сохранить",
          saving: "Сохранение...",
          saveError: "Не удалось сохранить прокси",
        },
        systemPrompt: {
      ...
      terminalProfiles: {
        ...
        namePlaceholder: "Oh My Pi",
        commandPlaceholder: "omp",
        argsPlaceholder: "--mode rpc-ui",
        nameLabel: "Название",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети. OMP Desktop переподключится автоматически. Дождитесь подключения перед перезапуском.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск. OMP Desktop переподключается автоматически. Повторите попытку, когда хост появится в сети.",
    ...
    imageGeneration: {
      ...
      description:
        "Позволяет агентам создавать растровые изображения и показывать их прямо в диалоге.",
      enabledAccessibilityLabel: "Включить генерацию изображений",
      status: {
        notConfigured: "Ключ API OpenAI не настроен",
        environment: "Ключ API задан через OPENAI_API_KEY",
        configured: "Ключ API настроен",
        noSubscriptionAccount: "Нет подключённого аккаунта с подпиской OpenAI Codex",
        selectSubscriptionAccount: "Выберите аккаунт с подпиской OpenAI Codex",
        subscriptionConfigured: "{{account}} · {{plan}}",
      },
      toolsDisabled:
        "Внедрение инструментов Paseo отключено. Включите его в настройках оркестрации хоста.",
      source: {
        label: "Источник изображений",
        hint: "Оплата API и подписка ChatGPT независимы. Автоматического переключения между ними нет.",
        api: "OpenAI API",
        subscription: "Подписка ChatGPT",
      },
      model: "Модель изображений",
      baseUrl: "Базовый URL (необязательно)",
      subscriptionAccount: "Аккаунт OpenAI Codex",
      subscriptionAccountPlaceholder: "Выберите аккаунт с подпиской",
      subscriptionAccountEmpty: "Нет подключённых аккаунтов OpenAI Codex",
      subscriptionHint:
        "Использует подписку ChatGPT выбранного аккаунта и фиксированную модель gpt-image-2.",
      accountFallback: "Аккаунт OpenAI Codex {{number}}",
      unknownPlan: "Подписка",
      apiKey: "Ключ API OpenAI",
      apiKeyConfiguredPlaceholder: "Настроен — введите новый ключ для замены",
      apiKeyPlaceholder: "sk-...",
      save: "Сохранить",
      saving: "Сохранение...",
      removeApiKey: "Удалить ключ API",
      saveError: "Не удалось сохранить настройки генерации изображений",
    },
    providers: {
      omp: ompProviderSettings.ru,
      title: "Провайдеры",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint:
          "OMP Desktop управляет процессом и назначает порт через переменную $PASEO_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалить",
      ...
      metadata: {
        title: "Генерация метаданных",
        info: "Инструкции для этого проекта, добавляемые в промпты ИИ, с помощью которых OMP Desktop генерирует метаданные. Используйте их, чтобы соблюдать принятые в команде правила именования веток, оформления коммитов и формата PR.",
