  ...
  settings: {
    ...
    host: {
      ...
      orchestration: {
        ...
        proxy: {
          title: "Прокси OMP",
          hint: "Задаёт PI_PROXY для новых процессов OMP. Очистите значение, чтобы отключить прокси.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "URL прокси OMP",
          save: "Сохранить",
          saving: "Сохранение...",
          saveError: "Не удалось сохранить прокси OMP",
        },
        systemPrompt: {
