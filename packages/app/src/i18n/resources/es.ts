  ...
  settings: {
    ...
    host: {
      ...
      orchestration: {
        ...
        proxy: {
          title: "Proxy de OMP",
          hint: "Configura PI_PROXY para los nuevos procesos de OMP. Borre el valor para desactivarlo.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "URL del proxy de OMP",
          save: "Guardar",
          saving: "Guardando...",
          saveError: "No se pudo guardar el proxy de OMP",
        },
        systemPrompt: {
