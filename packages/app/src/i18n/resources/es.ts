...
export const es: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    methods: {
      directorySearch: {
        ...
        description: "Buscar un directorio en {{host}}",
      },
      browse: {
        label: "Explorar",
      ...
      github: {
        ...
        searchDescription: "Buscar proyectos disponibles para tu cuenta de GitHub",
        manualDescription: "Introduce una URL de GitHub o owner/repo",
        unavailableDescription: "Actualiza este host para clonar repositorios de GitHub",
      },
      newDirectory: {
        label: "Nuevo directorio",
        description: "Crear un directorio vacío en {{host}}",
        unavailableDescription: "Actualiza este host para crear directorios",
      },
    },
  ...
  composer: {
    ...
    attachments: {
      ...
      removeDirectory: "Quitar carpeta adjunta",
      ...
      quoteSelection: "Citar contenido",
      quotedContent: "Contenido citado",
      removeQuotedContent: "Eliminar contenido citado",
    },
    errors: {
      ...
      directoryPickFailed: "No se pudo seleccionar la carpeta",
      directoryRequiresLocalDaemon: "Las carpetas solo se pueden adjuntar a un host local",
  ...
  agentControls: {
    ...
    mode: {
      ...
      options: {
        ...
        writeApproval: "Aprobar escrituras",
  ...
  agentStream: {
    ...
    activityGroup: "Razonamiento y llamadas a herramientas",
    permission: {
      plan: "Plan",
      required: "Permiso requerido",
      deny: "Denegar",
      accept: "Aceptar",
      implement: "Aprobar e implementar",
    ...
    turnFileChanges: {
      ...
      showMore: "Mostrar {{count}} archivos más",
      moreCount: "+{{count}}",
      collapse: "Mostrar menos",
      restoreTitle: "Restaurar archivo eliminado",
      restoreMessage: '¿Restaurar "{{name}}"? Volverá a su estado antes de este cambio.',
      restoreConfirm: "Restaurar",
      restoreSuccess: "Se restauró {{name}}",
      restoreFailed: "No se pudo restaurar {{name}}",
    },
  },
  agentPanel: {
    states: {
  ...
  workspace: {
    ...
    fileExplorer: {
      ...
      contentSearch: {
        ...
        includePlaceholder: "Archivos que incluir (por ejemplo, src/**)",
        excludePlaceholder: "Archivos que excluir (por ejemplo, dist/**)",
        ...
        startTyping: "Escribe para buscar en el workspace",
    ...
    git: {
      ...
      diff: {
        ...
        commits: {
          title: "Commits",
          countLabel: "{{count}} commits de la rama actual",
      ...
      forgeSetup: {
        ...
        nativeSignIn: "Inicia sesión en {{brand}} para usar repositorios y pull requests.",
        oauthNotConfigured:
          "{{brand}} OAuth no está configurado en esta compilación. Define PASEO_GITHUB_OAUTH_CLIENT_ID en el daemon y reinícialo.",
        signInButton: "Iniciar sesión en GitHub",
        deviceInstructions:
          "Introduce este código de un solo uso en la página de autorización de GitHub.",
        copyCode: "Copiar código",
        openAuthorization: "Abrir página de autorización",
        codeCopied: "Código de autorización copiado",
        signedIn: "Sesión iniciada como {{login}}",
      },
    },
  },
  workspaceLabels: {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        copyPath: "Copiar ruta",
        copyBranchName: "Copiar nombre de sucursal",
        referenceContent: "Referenciar contenido",
      ...
      confirmations: {
        ...
        deleteTitle: "¿Eliminar {{name}}?",
        deleteMessage:
          "Esto elimina permanentemente el historial de la conversación. Si es un worktree administrado, también se eliminan sus archivos y los cambios no confirmados.",
      },
      rename: {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queOMP Desktopinicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroOMP Desktopno pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deOMP Desktop",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeOMP DesktopenRosettaenApple Silicon.",
      highCpu:
  ...
  rootError: {
    title: "OMP Desktop tuvo un problema.",
  ...
  modelSelector: {
    ...
    contextWindowUseDefault: "Usar valor predeterminado",
    contextWindowInputAccessibility: "Anulación de ventana de contexto en tokens",
    contextWindowSave: "Guardar",
    contextWindowEdit: "Editar",
    contextWindowReset: "Restablecer",
    contextWindowInvalid: "Introduce un número entero positivo de tokens.",
    contextWindowHint: "La anulación se aplica a las sesiones nuevas de este modelo.",
  },
  providerCatalog: {
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorOMP Desktop.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de OMP Desktop",
  ...
  subagents: {
    ...
    pillLabelCompleted: "{{count}} completados",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "llamó a OMP Desktop {{count}} vez",
      other: "llamó a OMP Desktop {{count}} veces",
    },
    and: "y",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "OMP Desktop entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      preferred: "Manual",
      automaticHint: "OMP Desktop elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa OMP Desktop",
      model: "Modelo",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaOMP Desktopen esta computadora.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deOMP Desktop?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesOMP Desktop?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónOMP Desktopde ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        proxy: {
          title: "Proxy",
          hint: "Se usa para nuevos procesos de OMP y solicitudes de cuota de Codex y Cursor. Borre el valor para desactivarlo.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "URL del proxy",
          save: "Guardar",
          saving: "Guardando...",
          saveError: "No se pudo guardar el proxy",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.OMP Desktopse vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.OMP Desktopse vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
    ...
    imageGeneration: {
      ...
      description:
        "Permite que los agentes generen imágenes ráster y las muestren en la conversación.",
      enabledAccessibilityLabel: "Activar generación de imágenes",
      status: {
      ...
      save: "Guardar",
      saving: "Guardando...",
      removeApiKey: "Eliminar clave de API",
      saveError: "No se pudo guardar la configuración de generación de imágenes",
    },
    providers: {
      omp: ompProviderSettings.es,
      title: "Proveedores",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OMP Desktopsupervisa el proceso y asigna un puerto vía $PASEO_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queOMP Desktoputiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
