  ...
  settings: {
    ...
    host: {
      ...
      orchestration: {
        ...
        proxy: {
          title: "Proxy OMP",
          hint: "Définit PI_PROXY pour les nouveaux processus OMP. Effacez la valeur pour le désactiver.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "URL du proxy OMP",
          save: "Enregistrer",
          saving: "Enregistrement...",
          saveError: "Impossible d’enregistrer le proxy OMP",
        },
        systemPrompt: {
