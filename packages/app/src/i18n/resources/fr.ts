...
export const fr: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    methods: {
      directorySearch: {
        ...
        description: "Rechercher un dossier sur {{host}}",
      },
      browse: {
        label: "Parcourir",
      ...
      github: {
        ...
        manualDescription: "Saisir une URL GitHub ou owner/repo",
        unavailableDescription: "Mettez à jour cet hôte pour cloner des dépôts GitHub",
      },
      newDirectory: {
        label: "Nouveau dossier",
        description: "Créer un dossier vide sur {{host}}",
        unavailableDescription: "Mettez à jour cet hôte pour créer des dossiers",
      },
    },
  ...
  composer: {
    ...
    attachments: {
      ...
      removeDirectory: "Supprimer le dossier joint",
      ...
      quoteSelection: "Citer le contenu",
      quotedContent: "Contenu cité",
      removeQuotedContent: "Supprimer le contenu cité",
    },
    errors: {
      ...
      directoryPickFailed: "Impossible de sélectionner le dossier",
      directoryRequiresLocalDaemon: "Les dossiers ne peuvent être joints qu’à un hôte local",
  ...
  agentControls: {
    ...
    mode: {
      ...
      options: {
        ...
        writeApproval: "Approuver les écritures",
  ...
  agentStream: {
    ...
    activityGroup: "Réflexion et appels d’outils",
    permission: {
      plan: "Plan",
      required: "Autorisation requise",
      deny: "Refuser",
      accept: "Accepter",
      implement: "Approuver et mettre en œuvre",
  ...
  agentPanel: {
    states: {
      ...
      historyUnavailableTitle: "Historique de conversation indisponible",
      historyUnavailableMissing:
        "Cet agent existe toujours, mais le fichier de conversation du fournisseur a été supprimé. Les éventuels messages en cache ci-dessus sont en lecture seule.",
      historyUnavailableMalformed:
        "Cet agent existe toujours, mais le fichier de conversation du fournisseur est incomplet ou endommagé. Les éventuels messages en cache ci-dessus sont en lecture seule.",
      historyUnavailableEmpty: "Aucun message de conversation récupérable n’est disponible.",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'est pas géré par OMP Desktop",
          mergePrNoForge:
      ...
      diff: {
        ...
        commits: {
          title: "Commits",
          countLabel: "{{count}} commits sur la branche actuelle",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        copyPath: "Copier le chemin",
        copyBranchName: "Copier le nom de la branche",
        referenceContent: "Référencer le contenu",
      ...
      confirmations: {
        ...
        deleteTitle: "Supprimer {{name}} ?",
        deleteMessage:
          "Cette action supprime définitivement l’historique de la conversation. S’il s’agit d’un worktree géré, ses fichiers et modifications non validées sont également supprimés.",
      },
      rename: {
  ...
  newWorkspace: {
    ...
    errors: {
      hostDisconnected: "Hostn'est pas connecté",
      createWorkspaceFailed: "Échec de la création de l’espace de travail",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezOMP Desktopdémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisOMP Desktopn'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezOMP Desktop",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeOMP DesktopsousRosettasurApple Silicon.",
      highCpu:
  ...
  rootError: {
    title: "OMP Desktop a rencontré un problème.",
  ...
  workspaceSetup: {
    ...
    errors: {
      failedCreateWorkspace: "Échec de la création de l’espace de travail",
  ...
  onboarding: {
    title: "Bienvenue surOMP Desktop",
  ...
  modelSelector: {
    ...
    contextWindowUseDefault: "Utiliser la valeur par défaut",
    contextWindowInputAccessibility: "Remplacement de la fenêtre de contexte en jetons",
    contextWindowSave: "Enregistrer",
    contextWindowEdit: "Modifier",
    contextWindowReset: "Réinitialiser",
    contextWindowInvalid: "Saisissez un nombre entier positif de jetons.",
    contextWindowHint: "Le remplacement s’applique aux nouvelles sessions de ce modèle.",
  },
  providerCatalog: {
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurOMP Desktop.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais OMP Desktop",
  ...
  subagents: {
    ...
    pillLabelCompleted: "{{count}} terminés",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "a appelé OMP Desktop {{count}} fois",
      other: "a appelé OMP Desktop {{count}} fois",
    },
    and: "et",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "OMP Desktop a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      preferred: "Manuel",
      automaticHint: "OMP Desktop choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par OMP Desktop",
      model: "Modèle",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourOMP Desktopsur cet ordinateur",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesOMP Desktop?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesOMP Desktop?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationOMP Desktopde ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        proxy: {
          title: "Proxy",
          hint: "Utilisé pour les nouveaux processus OMP et les requêtes de quota Codex et Cursor. Effacez la valeur pour le désactiver.",
          placeholder: "http://127.0.0.1:7890",
          accessibilityLabel: "URL du proxy",
          save: "Enregistrer",
          saving: "Enregistrement...",
          saveError: "Impossible d’enregistrer le proxy",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.OMP Desktopse reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.OMP Desktopse reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par OMP Desktop Desktop. Mettez à jour OMP Desktop Desktop sur l’hôte.",
    ...
    imageGeneration: {
      ...
      description:
        "Autorise les agents à générer des images matricielles et à les afficher dans la conversation.",
      enabledAccessibilityLabel: "Activer la génération d’images",
      status: {
        notConfigured: "Clé API OpenAI non configurée",
        environment: "Clé API fournie par OPENAI_API_KEY",
        configured: "Clé API configurée",
        noSubscriptionAccount: "Aucun compte avec abonnement OpenAI Codex n’est connecté",
        selectSubscriptionAccount: "Sélectionnez un compte avec abonnement OpenAI Codex",
        subscriptionConfigured: "{{account}} · {{plan}}",
      },
      toolsDisabled:
        "L’injection des outils Paseo est désactivée. Activez-la dans les réglages d’orchestration de l’hôte.",
      source: {
        label: "Source d’images",
        hint: "La facturation API et les abonnements ChatGPT sont distincts. Aucun basculement automatique n’est effectué.",
        api: "API OpenAI",
        subscription: "Abonnement ChatGPT",
      },
      model: "Modèle d’image",
      baseUrl: "URL de base (facultatif)",
      subscriptionAccount: "Compte OpenAI Codex",
      subscriptionAccountPlaceholder: "Sélectionnez un compte avec abonnement",
      subscriptionAccountEmpty: "Aucun compte OpenAI Codex n’est connecté",
      subscriptionHint:
        "Utilise l’abonnement ChatGPT du compte sélectionné et le modèle fixe gpt-image-2.",
      accountFallback: "Compte OpenAI Codex {{number}}",
      unknownPlan: "Abonnement",
      apiKey: "Clé API OpenAI",
      apiKeyConfiguredPlaceholder: "Configurée — saisissez une nouvelle clé pour la remplacer",
      apiKeyPlaceholder: "sk-...",
      save: "Enregistrer",
      saving: "Enregistrement...",
      removeApiKey: "Supprimer la clé API",
      saveError: "Impossible d’enregistrer les réglages de génération d’images",
    },
    providers: {
      omp: ompProviderSettings.fr,
      title: "Fournisseurs",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OMP Desktopsupervise le processus et attribue un port via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queOMP Desktoputilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
