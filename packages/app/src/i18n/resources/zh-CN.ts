...
export const zhCN: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    methods: {
      ...
      github: {
        label: "从 GitHub 克隆",
        searchDescription: "搜索你的 GitHub 账户可访问的项目",
        manualDescription: "输入 GitHub URL 或 owner/repo",
        unavailableDescription: "更新此主机以克隆 GitHub 仓库",
      },
      newDirectory: {
        label: "新建目录",
        description: "在 {{host}} 上创建空目录",
        unavailableDescription: "更新此主机以创建目录",
      },
    },
    updateHost: "更新主机以使用“添加项目”。",
  ...
  composer: {
    ...
    errors: {
      ...
      directoryPickFailed: "无法选择文件夹",
      directoryRequiresLocalDaemon: "文件夹只能附加到本地主机",
  ...
  workspace: {
    ...
    git: {
      ...
      forgeSetup: {
        ...
        oauthNotConfigured:
          "此构建未配置 {{brand}} OAuth。请在 daemon 环境设置 PASEO_GITHUB_OAUTH_CLIENT_ID，然后重启 daemon。",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      confirmations: {
        ...
        deleteTitle: "删除「{{name}}」？",
        deleteMessage:
          "这会永久删除对话记录。如果这是应用管理的工作树，其文件和未提交的更改也会一并删除。",
      },
      rename: {
        title: "重命名",
        submit: "重命名",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "管理内置 daemon",
        hint: "让 OMP Desktop 启动和停止内置 daemon",
        pauseTitle: "暂停内置 daemon",
        pauseMessage:
          "这会立即停止内置 daemon。连接到内置 daemon 的运行中 agents 和 terminals 会被停止。",
        pauseAndStop: "暂停并停止",
        registrationFailed:
          "内置 daemon 已启动，但 OMP Desktop 无法保存 localhost 连接。请关闭后重新开启 daemon 管理，或手动添加 localhost。",
        pausedStopFailed: "内置 daemon 管理已暂停，但 OMP Desktop 无法停止 daemon。",
        updateFailed: "无法更新内置 daemon 管理设置。",
      },
      keepRunning: {
        title: "退出后保持 daemon 运行",
        hint: "退出 OMP Desktop 后 daemon 会继续运行",
      },
      logs: {
        title: "日志文件",
    ...
    rosetta: {
      ...
      runningIntel: "你正在 Apple Silicon 上通过 Rosetta 运行 OMP Desktop 的 Intel 构建。",
  ...
  pairing: {
    ...
    direct: {
      title: "直接连接",
      helper: "输入 OMP Desktop server 的地址。",
      fields: {
        host: "Host",
        port: "端口",
        password: "密码",
    ...
    device: {
      ...
      relayDocs: "中继如何工作",
      relayDocsAccessibility: "阅读 OMP Desktop 中继的工作原理",
      enableRelay: "启用中继",
      enablingRelay: "正在启用...",
      notNow: "暂不",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "调用了 OMP Desktop {{count}} 次",
      other: "调用了 OMP Desktop {{count}} 次",
    },
    and: "并",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sending: "正在发送...",
      sentTitle: "测试通知已发送",
      sentDescription: "OMP Desktop 已将通知交给操作系统。",
    ...
    metadataGeneration: {
      ...
      automatic: "自动",
      preferred: "手动",
      automaticHint: "OMP Desktop 会选择一个可用的快速模型",
      preferredHint: "选择 OMP Desktop 使用的模型",
      model: "模型",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "这会更新此电脑上的 OMP Desktop",
        installConfirm: "安装更新",
        update: "更新",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "更新 OMP Desktop skills？",
        updateFallback: "将内置 skills 同步到你的机器。",
        uninstallTitle: "卸载 OMP Desktop skills？",
        uninstallMessage: "会从 ~/.agents、~/.claude、~/.codex 移除所有 OMP Desktop 编排 skills。",
        choose: "选择 skills",
        chooseAll: "全部 skills",
      ...
      orchestration: {
        ...
        proxy: {
          title: "代理",
          hint: "用于新启动的 OMP 进程及 Codex、Cursor 等额度接口。清空该值即可停用代理。",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage: "这个 Host 已离线。OMP Desktop 会自动重连，请等它恢复在线后再重启。",
          requestFailedTitle: "错误",
          requestFailedMessage:
            "发送重启请求失败。OMP Desktop 会自动重连，请在 Host 显示在线后重试。",
      ...
      ompPlugins: {
        title: "OMP 插件",
        description: "管理 OMP 运行时中安装的插件(omp plugin)。",
        listTitle: "已安装",
        installTitle: "安装",
        ...
        states: {
          ...
          empty: "尚未安装 OMP 插件",
          offlineTitle: "主机离线",
          offlineDescription: "重新连接该主机以管理它的 OMP 插件。",
        },
      },
    },
    imageGeneration: {
      title: "图片生成",
      enabled: "启用图片生成",
      description: "允许 Agent 生成位图，并直接显示在对话中。",
      enabledAccessibilityLabel: "启用图片生成",
      status: {
        notConfigured: "尚未配置 OpenAI API Key",
        environment: "API Key 由 OPENAI_API_KEY 环境变量提供",
        configured: "已配置 API Key",
        noSubscriptionAccount: "尚未登录 OpenAI Codex 订阅账户",
        selectSubscriptionAccount: "请选择 OpenAI Codex 订阅账户",
        subscriptionConfigured: "{{account}} · {{plan}}",
      },
      toolsDisabled: "Paseo 工具注入已关闭，请先在 Host 编排设置中启用。",
      source: {
        label: "图片来源",
        hint: "API 计费与 ChatGPT 订阅相互独立，请求不会在两者之间自动降级。",
        api: "OpenAI API",
        subscription: "ChatGPT 订阅",
      },
      model: "图片模型",
      baseUrl: "Base URL（可选）",
      subscriptionAccount: "OpenAI Codex 账户",
      subscriptionAccountPlaceholder: "选择订阅账户",
      subscriptionAccountEmpty: "没有已登录的 OpenAI Codex 账户",
      subscriptionHint: "使用所选账户的 ChatGPT 订阅，模型固定为 gpt-image-2。",
      accountFallback: "OpenAI Codex 账户 {{number}}",
      unknownPlan: "订阅",
      apiKey: "OpenAI API Key",
      apiKeyConfiguredPlaceholder: "已配置，输入新 Key 可替换",
      apiKeyPlaceholder: "sk-...",
      save: "保存",
      saving: "保存中...",
      removeApiKey: "移除 API Key",
      saveError: "无法保存图片生成设置",
    },
    providers: {
      omp: ompProviderSettings["zh-CN"],
      title: "模型服务商",
      addProvider: "添加模型服务商",
      providerDetails: "{{name}} 服务商详情",
      enableProvider: "启用 {{name}}",
      unavailable: "连接到此主机以查看模型服务商",
      loading: "正在加载...",
      addErrorTitle: "无法添加模型服务商",
      updateErrorTitle: "无法更新模型服务商",
      actions: {
        menu: "{{name}} 操作",
        remove: "移除模型服务商",
        removing: "正在移除...",
      ...
      remove: {
        ...
        confirmMessage: "这会删除 config.json 中的服务商配置，且无法撤销。",
        confirm: "移除",
        errorTitle: "无法移除模型服务商",
      },
      statuses: {
        disabled: "已禁用",
        loading: "正在加载",
    ...
    project: {
      ...
      scripts: {
        ...
        editScript: "编辑 {{name}}",
        runAsService: "作为服务运行",
        serviceHint: "OMP Desktop 会监管该进程，并通过 $PASEO_PORT 分配端口",
        actions: {
          add: "添加 script",
          edit: "编辑",
          remove: "移除",
      ...
      metadata: {
        title: "元数据生成",
        info: "注入到 OMP Desktop 用来生成元数据的 AI prompts 中的 Project 专属指令，可用于强制执行团队约定，例如分支命名、提交风格或 PR 格式",
        branchName: "分支名称",
