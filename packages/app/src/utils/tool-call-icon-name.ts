import type { ToolCallDetail, ToolCallIconName } from "@omp-desktop/protocol/agent-types";
import { isPaseoToolName } from "@omp-desktop/protocol/tool-name-normalization";
