...
import type { AgentProfile } from "@omp-desktop/protocol/messages";
...
const PREFERENCES_KEY = "@omp-desktop:create-agent-preferences";
const COMPLETION_KEY_PREFIX = "@omp-desktop:legacy-favorites-to-agent-profiles:v1:";
