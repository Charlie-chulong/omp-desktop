  ...
  const handleDelete = useCallback(() => {
    void (async () => {
      ...
      const confirmed = await confirmDialog({
        title: t("schedules.deleteConfirm.title", { product: productName }),
        message: t("schedules.deleteConfirm.message", {
          title: resolveScheduleTitle(schedule, t),
        }),
        confirmLabel: t("schedules.deleteConfirm.confirm"),
        destructive: true,
      });
      if (!confirmed) {
        return;
