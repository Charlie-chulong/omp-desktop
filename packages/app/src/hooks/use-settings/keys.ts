...
export const APP_SETTINGS_KEY = "@omp-desktop:app-settings";
export const LEGACY_SETTINGS_KEY = "@omp-desktop:settings";
 ...
 */
export const SETTINGS_MIGRATIONS_KEY = "@omp-desktop:settings-migrations";
