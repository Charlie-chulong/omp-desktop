...
function getTextAttachmentSubtitle(
  ...
  if (attachment.contextKind === "directory") {
    return t("message.attachments.directory");
  }
...
export function getAgentAttachmentPillContent(
  ...
  switch (attachment.type) {
    ...
    case "text":
      ...
      return {
        icon: attachment.contextKind === "directory" ? attachmentDirectoryIcon : attachmentFileIcon,
