...
const MutableImageGenerationConfigSchema = z
  .object({
    enabled: z.boolean(),
...
export const AgentTimelineItemPayloadSchema: z.ZodType<AgentTimelineItem, unknown> = z.union([
  ...
  z.object({
    ...
    text: z.string(),
    messageId: z.string().optional(),
    presentation: z.literal("plan").optional(),
  }),
  z.object({
...
const AgentDirectoryFilterSchema = z.object({
  ...
  // COMPAT(agentWorkspaceFilter): added in v0.5.3, remove optional after 2027-08-25.
...
export const TextAttachmentSchema = z
  ...
  .transform(({ contextKind, ...attachment }) => ({
    ...attachment,
    ...(contextKind === "chat_history" || contextKind === "directory" ? { contextKind } : {}),
  }));
...
export const OmpProviderManagementGetRequestMessageSchema = z.object({
  type: z.literal("omp.provider.management.get.request"),
  requestId: z.string(),
});
...
export const OmpCustomProviderInputSchema = z.object({
  ...
  api: OmpProviderApiSchema,
  models: z.array(OmpCustomProviderModelInputSchema).min(1),
});
export const OmpProviderModelDiscoveryRequestMessageSchema = z.object({
  type: z.literal("omp.provider.models.discover.request"),
  baseUrl: z.string().trim().url(),
  apiKey: z.string().trim().min(1),
  requestId: z.string(),
});

export const OmpProviderManagementAddRequestMessageSchema = z.object({
  type: z.literal("omp.provider.management.add.request"),
  provider: OmpCustomProviderInputSchema,
  requestId: z.string(),
});

export const OmpProviderManagementRemoveRequestMessageSchema = z.object({
  type: z.literal("omp.provider.management.remove.request"),
  providerId: z.string().trim().min(1),
  requestId: z.string(),
});
export const OmpInstallStatusRequestMessageSchema = z.object({
  type: z.literal("omp.install.status.request"),
...
export const OmpProviderLoginStartRequestMessageSchema = z.object({
  type: z.literal("omp.provider.login.start.request"),
  providerId: z.string().min(1),
  requestId: z.string(),
});

export const OmpProviderLoginFinishRequestMessageSchema = z.object({
  type: z.literal("omp.provider.login.finish.request"),
...
export const SetAgentGoalObjectiveRequestMessageSchema = z.object({
  type: z.literal("set_agent_goal_objective_request"),
  agentId: z.string(),
  objective: z.string().trim().min(1),
  requestId: z.string(),
});

export const SetAgentGoalObjectiveResponseMessageSchema = z.object({
  type: z.literal("set_agent_goal_objective_response"),
  payload: AgentActionResponsePayloadSchema,
});

export const ControlAgentGoalRequestMessageSchema = z.object({
  type: z.literal("control_agent_goal_request"),
  agentId: z.string(),
  action: z.enum(["start", "pause", "delete"]),
  requestId: z.string(),
});

export const ControlAgentGoalResponseMessageSchema = z.object({
  type: z.literal("control_agent_goal_response"),
  payload: AgentActionResponsePayloadSchema,
});
...
export const DeleteWorkspaceRequestSchema = z.object({
  type: z.literal("delete_workspace_request"),
  workspaceId: z.string(),
  requestId: z.string(),
});
...
export const SessionInboundMessageSchema = z.discriminatedUnion("type", [
  ...
  OmpInstallStatusRequestMessageSchema,
  ...
  SetAgentGoalObjectiveRequestMessageSchema,
  ControlAgentGoalRequestMessageSchema,
...
export const DeleteWorkspaceResponseMessageSchema = z.object({
...
export const OmpProviderManagementRemoveResponseMessageSchema = z.object({
  type: z.literal("omp.provider.management.remove.response"),
  payload: OmpProviderManagementSchema.extend({ requestId: z.string() }),
});
export const OmpProviderModelDiscoveryResponseMessageSchema = z.object({
  type: z.literal("omp.provider.models.discover.response"),
  payload: z.object({
    requestId: z.string(),
    models: z.array(
      z.object({
...
export const OmpInstallStatusResponseMessageSchema = z.object({
  type: z.literal("omp.install.status.response"),
  payload: OmpInstallationStatusSchema.extend({ requestId: z.string() }),
});

export const OmpInstallResponseMessageSchema = z.object({
  type: z.literal("omp.install.response"),
  payload: OmpInstallationStatusSchema.extend({ requestId: z.string() }),
});

export const OmpProviderLoginStartResponseMessageSchema = z.object({
  type: z.literal("omp.provider.login.start.response"),
  payload: z.object({
    requestId: z.string(),
    flowId: z.string(),
    providerId: z.string(),
...
export const SessionOutboundMessageSchema = z.discriminatedUnion("type", [
  ...
  DeleteWorkspaceResponseMessageSchema,
  ...
  SetAgentGoalObjectiveResponseMessageSchema,
  ControlAgentGoalResponseMessageSchema,
  ...
  OmpInstallStatusResponseMessageSchema,
...
export type DeleteWorkspaceResponseMessage = z.infer<typeof DeleteWorkspaceResponseMessageSchema>;
...
export type SetAgentGoalObjectiveResponseMessage = z.infer<
  typeof SetAgentGoalObjectiveResponseMessageSchema
>;
export type ControlAgentGoalResponseMessage = z.infer<typeof ControlAgentGoalResponseMessageSchema>;
...
export type OmpProviderManagementAddResponseMessage = z.infer<
  typeof OmpProviderManagementAddResponseMessageSchema
>;
export type OmpProviderManagementRemoveResponseMessage = z.infer<
  typeof OmpProviderManagementRemoveResponseMessageSchema
>;
export type OmpProviderModelDiscoveryResponseMessage = z.infer<
  typeof OmpProviderModelDiscoveryResponseMessageSchema
>;
export type OmpInstallationStatus = z.infer<typeof OmpInstallationStatusSchema>;
export type OmpInstallStatusResponseMessage = z.infer<typeof OmpInstallStatusResponseMessageSchema>;
...
>;
export type OmpProviderManagementGetRequestMessage = z.infer<
  typeof OmpProviderManagementGetRequestMessageSchema
>;
...
>;
export type OmpProviderManagementRemoveRequestMessage = z.infer<
  typeof OmpProviderManagementRemoveRequestMessageSchema
>;
export type OmpProviderModelDiscoveryRequestMessage = z.infer<
  typeof OmpProviderModelDiscoveryRequestMessageSchema
>;
...
export type SetAgentGoalObjectiveRequestMessage = z.infer<
  typeof SetAgentGoalObjectiveRequestMessageSchema
>;
export type ControlAgentGoalRequestMessage = z.infer<typeof ControlAgentGoalRequestMessageSchema>;
