...
import { loadConfig, resolvePaseoHome } from "@omp-desktop/server";
import {
...
import { DaemonClient, type WebSocketLike } from "@omp-desktop/client/internal/daemon-client";
...
const DEFAULT_HOST = "localhost:6770";
const DEFAULT_TIMEOUT = 15000;
const PID_FILENAME = "omp-desktop.pid";
