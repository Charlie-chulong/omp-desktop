...
import type { TerminalCell, TerminalState } from "@omp-desktop/protocol/messages";
import { TerminalInputModeTracker } from "@omp-desktop/protocol/terminal-input-mode";
...
const PASEO_CLI_BIN_ENTRY = "@omp-desktop/cli/bin/paseo";
