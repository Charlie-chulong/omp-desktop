import type { SubscribeTerminalRequest } from "@omp-desktop/protocol/messages";
import {
  TerminalStreamOpcode,
  encodeTerminalSnapshotPayload,
  encodeTerminalStreamFrame,
} from "@omp-desktop/protocol/binary-frames/index";
import { renderTerminalSnapshotToAnsi } from "@omp-desktop/protocol/terminal-snapshot";
