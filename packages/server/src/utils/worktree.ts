...
export {
  ...
  type PaseoConfig,
  type PaseoConfigRaw,
} from "@omp-desktop/protocol/paseo-config-schema";
import { PaseoConfigSchema, type PaseoConfig } from "@omp-desktop/protocol/paseo-config-schema";
import {
...
export { slugify, validateBranchSlug } from "@omp-desktop/protocol/branch-slug";
