// CLI exports for @omp-desktop/server
...
export { buildRelayWebSocketUrl } from "@omp-desktop/protocol/daemon-endpoints";
export {
...
export { PARENT_AGENT_ID_LABEL } from "@omp-desktop/protocol/agent-labels";
export {
