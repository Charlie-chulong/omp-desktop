  ...
  return {
    ...
    item: buildStatusLineNotice({
      ...
      metadata: {
        ...
        ...(goal?.objective ? { goalObjective: goal.objective } : {}),
        ...(goal?.tokenBudget !== undefined ? { goalTokenBudget: goal.tokenBudget } : {}),
        ...(goal?.tokensUsed !== undefined ? { goalTokensUsed: goal.tokensUsed } : {}),
        ...(goal?.timeUsedSeconds !== undefined
          ? { goalTimeUsedSeconds: goal.timeUsedSeconds }
          : {}),
        ...(goal?.createdAt ? { goalCreatedAt: goal.createdAt } : {}),
        ...(goal?.updatedAt ? { goalUpdatedAt: goal.updatedAt } : {}),
      },
    }),
  };
}
