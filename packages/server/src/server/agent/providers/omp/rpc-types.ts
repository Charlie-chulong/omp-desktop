...
export const OmpModelSchema = z
  ...
  .passthrough();
export const OmpLoginProviderSchema = z
  .object({
    id: z.string(),
    name: z.string(),
    available: z.boolean(),
...
export const OmpLoginProvidersResultSchema = z
  .object({ providers: z.array(OmpLoginProviderSchema).optional() })
  .passthrough();
...
export type OmpLoginProvider = z.infer<typeof OmpLoginProviderSchema>;
