    ...
    expect(
      mapOmpRuntimeEventToTimelineItem({
        ...
        goal: {
          ...
          updatedAt: "2026-08-26T10:00:12.000Z",
        },
        state: {
          enabled: true,
          mode: "active",
      ...
      item: {
        ...
        metadata: {
          ...
          goalId: "goal-1",
          goalStatus: "active",
          goalObjective: "Ship Phase 5",
          goalTokenBudget: 2000,
          goalTokensUsed: 345,
          goalTimeUsedSeconds: 12,
          goalCreatedAt: "2026-08-26T10:00:00.000Z",
          goalUpdatedAt: "2026-08-26T10:00:12.000Z",
        },
      },
    });
  });
